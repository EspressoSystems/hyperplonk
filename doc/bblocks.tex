...
\binyi{Remark: An alternative is to reduce $\RPERM$ to a \emph{single} $\RPROD$ instance plus a single $\RZERO$
instance. Same reduction holds for $\RLOOKUP$. Need to check which way is more efficient.}
