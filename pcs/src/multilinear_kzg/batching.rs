...
use super::{
    ...
    util::{build_l, compute_w_circ_l_with_prefix, merge_polynomials},
    verify_internal, MultilinearKzgBatchProof,
};
use crate::{
    multilinear_kzg::util::{build_l_with_prefix, compute_w_circ_l, get_uni_domain},
...
mod tests {
    ...
    use crate::{
        multilinear_kzg::util::{
            compute_qx_degree, generate_evaluations, generate_evaluations_single_poly,
        },
